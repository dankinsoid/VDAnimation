...
struct sRGB: Tweenable, Hashable {
    ...
    public static func fromLinear(_ linear: RGB) -> sRGB {
        sRGB(
            r: Self.linearToSRGB(linear.r),
            g: Self.linearToSRGB(linear.g),
            b: Self.linearToSRGB(linear.b)
        )
    }
...
private func degreesLerp(_ l: Double, _ r: Double, _ t: Double, period: Double = 360) -> Double {
